...
from .dataset import ChordDataset, split_data_to_batch, batch_padding
...
def get_data(args):
    ...
    train_data = batch_padding(train_data_batch, max_len)
    val_data = batch_padding(val_data_batch, max_len)
